                    ...
                    <TableRow key={i}>
                      ...
                      <TableCell>
                        <Input
                          type="number"
                          value={entry.shares || ''}
                          onChange={(e) => updateRow(i, 'shares', parseInt(e.target.value) || 0)}
                      ...
                      <TableCell>
                        <Input
                          type="number"
                          step="0.01"
                          value={entry.percentage ? (entry.percentage * 100).toFixed(2) : ''}
                          onChange={(e) => updateRow(i, 'percentage', (parseFloat(e.target.value) || 0) / 100)}
