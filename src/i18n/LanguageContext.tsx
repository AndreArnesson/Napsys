...
type Translations = {
  ...
  company: { overview: string; financials: string; balanceSheet: string; timeline: string; analysis: string; notes: string; description: string; moats: string; management: string; board: string; ceo: string; sharesOutstanding: string; currentPrice: string; reportingCurrency: string; tradingCurrency: string; ticker: string; keyData: string; insiders: string; importData: string };
  ...
  timeline: { title: string; analysis: string; comment: string; insiderBuy: string; ratingChange: string; noEvents: string };
