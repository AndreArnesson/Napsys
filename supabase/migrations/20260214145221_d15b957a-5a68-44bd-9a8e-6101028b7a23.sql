...
-- Companies table (IF NOT EXISTS - already created in earlier migration)
...
-- Income statement table (IF NOT EXISTS)
...
-- Balance sheet table (IF NOT EXISTS)
...
-- Timeline events table (IF NOT EXISTS)
